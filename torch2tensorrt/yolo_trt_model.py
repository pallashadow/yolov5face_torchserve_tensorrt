...
class YoloTrtModel():
    ...
    ONNX->TensorRT并推理
    '''
    def __init__(self, trt_engine_path, img_size=320):
        self.model_params=Init_TensorRT(trt_engine_path)

        # 输出特征
        self.stride8_shape=(1,3,img_size//8,img_size//8,16)
        self.stride16_shape=(1,3,img_size//16,img_size//16,16)
        self.stride32_shape=(1,3,img_size//32,img_size//32,16)
