...
_PREDICTIONSREQUEST_INPUTENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='org.pytorch.serve.grpc.inference.PredictionsRequest.InputEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='org.pytorch.serve.grpc.inference.PredictionsRequest.InputEntry.value', index=1,
...
_PREDICTIONSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='model_name', full_name='org.pytorch.serve.grpc.inference.PredictionsRequest.model_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='model_version', full_name='org.pytorch.serve.grpc.inference.PredictionsRequest.model_version', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='input', full_name='org.pytorch.serve.grpc.inference.PredictionsRequest.input', index=2,
  ...
  nested_types=[_PREDICTIONSREQUEST_INPUTENTRY, ],
  enum_types=[
  ],
...
_PREDICTIONRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='prediction', full_name='org.pytorch.serve.grpc.inference.PredictionResponse.prediction', index=0,
...
_TORCHSERVEHEALTHRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='health', full_name='org.pytorch.serve.grpc.inference.TorchServeHealthResponse.health', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
